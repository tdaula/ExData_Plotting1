...
#Plot 2
with(powerdf, plot(datetime, voltage ,xlab = "", ylab = "Voltage", type="n") )
with(powerdf, lines(datetime, voltage))
#Plot 3
...
#Plot 4
with(powerdf, plot(datetime, globalReactivePower, xlab = "", ylab = "Global_reactive_power", type="n") )
with(powerdf, lines(datetime, globalReactivePower))
